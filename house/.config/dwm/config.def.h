...
static const char *gradehr[]  = { "zathura", "~/Documents/7-semestre.pdf", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask|ControlMask, XK_Right,      spawn,          SHCMD("/usr/local/scripts/music-seekf") },       // SEEK FORWARD
	{ MODKEY|ShiftMask|ControlMask, XK_Left,       spawn,          SHCMD("/usr/local/scripts/music-seekb") },       // SEEK BACKWARD
    /**********************************************************************************************************************************/
