...
set showcmd
" Eu tenho meus indents para linguagens que uso
filetype indent off
" Syntax eh pelo TreeSitter
syntax on

" Cursor padrao do Vim
set guicursor=
...
" Removendo trailing white spaces em Python, C, Lua e Vim
...
" :terminal, comecar em Insert Mode
"augroup terminal
"    au TermOpen * startinsert
"augroup END

" mapear Esc para sair de Insert Mode no terminal
tnoremap <Esc> <C-\><C-n>
