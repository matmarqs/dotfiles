...
static const char *fonts[]          = { "Source Code Pro:style=Regular:size=10", "Font Awesome 5 Free:style=Solid:size=10", "Noto Sans CJK JP:style=Medium:size=10" };
...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_gray4, col_cyan,  "#5fff5f" },
};
...
static const char *gradehr[]  = { "zathura", "/home/sekai/documents/6-semestre.pdf", NULL };
static const char *printsz[]  = { "scrot", "-s", "/home/sekai/pictures/prints/%b-%d-%H:%M:%S.png", NULL };
static const char *printfs[]  = { "scrot", "/home/sekai/pictures/prints/%b-%d-%H:%M:%S.png", NULL };
...
static Key keys[] = {
    ...
    /************************************************************** MUSIC *************************************************************/
	{ MODKEY|ControlMask,           XK_equal,      spawn,          SHCMD("/home/sekai/scripts/music/music-vol_up") },      // UP
	{ MODKEY|ControlMask,           XK_Up,         spawn,          SHCMD("/home/sekai/scripts/music/music-vol_up") },      // UP
	{ MODKEY|ControlMask|ShiftMask, XK_equal,      spawn,          SHCMD("/home/sekai/scripts/music/music-vol_bigup") },   // BIG UP
	{ MODKEY|ControlMask|ShiftMask, XK_Up,         spawn,          SHCMD("/home/sekai/scripts/music/music-vol_bigup") },   // BIG UP
	{ MODKEY|ControlMask,           XK_minus,      spawn,          SHCMD("/home/sekai/scripts/music/music-vol_down") },    // DOWN
	{ MODKEY|ControlMask,           XK_Down,       spawn,          SHCMD("/home/sekai/scripts/music/music-vol_down") },    // DOWN
	{ MODKEY|ControlMask|ShiftMask, XK_minus,      spawn,          SHCMD("/home/sekai/scripts/music/music-vol_bigdown") }, // BIG DOWN
	{ MODKEY|ControlMask|ShiftMask, XK_Down,       spawn,          SHCMD("/home/sekai/scripts/music/music-vol_bigdown") }, // BIG DOWN
	{ 0,                            XK_Pause,      spawn,          SHCMD("/home/sekai/scripts/music/music-playpause") },   // PLAY-PAUSE
	{ MODKEY|ControlMask,           XK_Right,      spawn,          SHCMD("/home/sekai/scripts/music/music-next") },        // NEXT
	{ MODKEY|ControlMask,           XK_Left,       spawn,          SHCMD("/home/sekai/scripts/music/music-prev") },        // PREVIOUS
    /**********************************************************************************************************************************/
    ...
    /* O vanity gaps tem muita funcionalidade desnecessaria. Funcoes desabilitadas */
